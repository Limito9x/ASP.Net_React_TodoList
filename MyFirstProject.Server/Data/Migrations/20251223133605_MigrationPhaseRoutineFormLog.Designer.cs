...
namespace MyFirstProject.Server.Data.Migrations
{
    ...
    [Migration("20251223133605_MigrationPhaseRoutineFormLog")]
    partial class MigrationPhaseRoutineFormLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.Routine", b =>
                {
                    ...
                    b.Property<List<MetadataForm>>("Forms")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Forms"), "gin");
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.SingleTask", b =>
                {
                    ...
                    b.HasOne("MyFirstProject.Server.Models.Plan", null)
                        .WithMany("SingleTasks")
                        .HasForeignKey("PlanId");
