...
namespace MyFirstProject.Server.Migrations.Data
{
    ...
    [Migration("20260101001724_AddChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.ChatSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.Routine", b =>
                {
                    ...
                    b.Property<int?>("ExpectedTotalCount")
                        .HasColumnType("integer");

                    b.PrimitiveCollection<string>("LinkedFormIds")
                        .HasColumnType("jsonb");

                    b.Property<List<LinkedGoal>>("LinkedGoals")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.TaskLog", b =>
                {
                    ...
                    b.Property<List<Contribution>>("Contributions")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("MyFirstProject.Server.Models.ChatMessage", b =>
                {
                    b.HasOne("MyFirstProject.Server.Models.ChatSession", "Session")
                        .WithMany()
